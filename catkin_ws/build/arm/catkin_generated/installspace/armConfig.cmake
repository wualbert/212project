...
if("FALSE" STREQUAL "TRUE")
  set(arm_SOURCE_PREFIX /home/albertwu/me212project/catkin_ws/src/arm)
  set(arm_DEVEL_PREFIX /home/albertwu/me212project/catkin_ws/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/albertwu/me212project/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'albertwu <wualbert@mit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/albertwu/me212project/catkin_ws/install/${idir}'.  Ask the maintainer 'albertwu <wualbert@mit.edu>' to fix it.")
    endif()
